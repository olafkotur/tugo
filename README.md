...
* `git clone git@github.com:olafkotur/tugo.git`
...
* You must have an internet connection, alertnatively run `yarn start --offline` - this will allow you to run the simulator without internet
